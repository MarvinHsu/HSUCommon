...
import com.hsuforum.common.web.jsf.managedbean.BaseJpaManagedBean;
 ...
 *            Service
 */
public abstract class BaseJpaManagedBeanImpl<T extends BaseEntity<ID>, ID extends Serializable, SERVICE extends BaseService<T, ID>, JPA_SERVICE extends BaseJpaService<T,ID>>
		implements BaseJpaManagedBean<T, ID, SERVICE, JPA_SERVICE> {
