...
/**
 * Translate tradition chinese and simple chinese
 * @author Marvin
 *
 */
public class TranslationUtils {
    private static StringBuffer traditionBuffer =
    ...
    private static StringBuffer simpleBuffer =
    ...
    private static HashMap<Character, Character> tradition2Simple = new HashMap<Character, Character>();
    private static HashMap<Character, Character> simple2Tradition = new HashMap<Character, Character>();

    
    /**
     * form Map
     */
    public static void formMap() {

        int k = simpleBuffer.length();

        Character tradition = null;
        Character simple = null;
        for (int i = 0; i < k; i++) {
        	tradition = traditionBuffer.charAt(i);
        	simple = simpleBuffer.charAt(i);

            tradition2Simple.put(tradition, simple);
            simple2Tradition.put(simple, tradition);
     ...
     * @param type
     */
    public static void translate(StringBuffer from, String type) {
        formMap();
        int i = from.length();
        char come;

        if (type.equals("tradition2Simple")) {
            for (int k = 0; k < i; k++) {
                come = from.charAt(k);
                if (tradition2Simple.containsKey(come)) {
                    from.setCharAt(k, tradition2Simple.get(come));
            ...
            for (int k = 0; k < i; k++) {
                ...
                if (simple2Tradition.containsKey(come)) {

                    from.setCharAt(k, simple2Tradition.get(come));
